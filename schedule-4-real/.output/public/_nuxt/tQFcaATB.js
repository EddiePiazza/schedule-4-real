import{r as ve}from"./pPnvt0E1.js";import{r as be}from"./CN1dyj__.js";import{r as we}from"./BM5md_Jc.js";import{o as i,c as n,a as e,e as le,h as o,b as I,t as g,n as z,f as S,m as f,x as de,y as te,g as _e,z as xe,F as B,r as G,A as Z,i as L,v as Y,s as ke,d as Oe,j as De,k as Ce,D as ae,B as Se,p as R}from"./PA7XRBe8.js";import{s as Ie}from"./DhCWJxiG.js";import{r as oe}from"./DXjAK_A6.js";import{r as Ae}from"./BE3LsoYs.js";import{r as re}from"./kRzUAdsC.js";function Pe(d,p){return i(),n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true","data-slot":"icon"},[e("path",{d:"M3.478 2.404a.75.75 0 0 0-.926.941l2.432 7.905H13.5a.75.75 0 0 1 0 1.5H4.984l-2.432 7.905a.75.75 0 0 0 .926.94 60.519 60.519 0 0 0 18.445-8.986.75.75 0 0 0 0-1.218A60.517 60.517 0 0 0 3.478 2.404Z"})])}const Ne={key:0,class:"flex items-start gap-2 px-3 py-1.5"},Ee={class:"flex-1 min-w-0"},Te={class:"text-[13px] font-medium truncate"},$e={key:0,class:"mt-1.5 bg-gray-900/80 rounded-lg p-2.5 border border-gray-700/50 overflow-x-auto"},Fe={class:"text-[12px] text-gray-400 whitespace-pre-wrap break-all leading-relaxed"},je={key:1,class:"flex justify-end px-3 py-1"},Ve={class:"max-w-[85%] bg-spider-green-600/20 border border-spider-green-500/30 rounded-2xl rounded-tr-md px-3.5 py-2"},Le={class:"text-base text-gray-200 whitespace-pre-wrap break-words leading-relaxed"},Re={key:2,class:"flex justify-start px-3 py-1"},Ue={class:"max-w-[85%] bg-violet-600/10 border border-violet-500/20 rounded-2xl rounded-tl-md px-3.5 py-2"},Me={class:"text-base text-gray-200 whitespace-pre-wrap break-words leading-relaxed"},He={key:3,class:"flex justify-start px-3 py-1"},We={class:"max-w-[85%] bg-amber-600/10 border border-amber-500/20 rounded-2xl rounded-tl-md px-3.5 py-2"},Be={class:"flex items-center gap-1.5 mb-1"},Ge={class:"text-base text-gray-200 whitespace-pre-wrap break-words leading-relaxed"},Ye=le({__name:"AIChatMessage",props:{msg:{}},setup(d){const p=f(!1);function v(c){return c?c.replace(/_/g," "):"tool"}function O(c){try{return JSON.stringify(JSON.parse(c),null,2)}catch{return c}}return(c,u)=>d.msg.role==="tool"?(i(),n("div",Ne,[e("div",Ee,[e("button",{onClick:u[0]||(u[0]=D=>p.value=!o(p)),class:"flex items-center gap-1.5 text-gray-500 hover:text-gray-300 transition-colors"},[I(o(ve),{class:"w-3.5 h-3.5 shrink-0"}),e("span",Te,g(v(d.msg.toolName)),1),I(o(be),{class:z(["w-3 h-3 transition-transform shrink-0",o(p)?"rotate-90":""])},null,8,["class"])]),o(p)?(i(),n("div",$e,[e("pre",Fe,g(O(d.msg.content)),1)])):S("",!0)])])):d.msg.role==="user"?(i(),n("div",je,[e("div",Ve,[e("p",Le,g(d.msg.content),1)])])):d.msg.role==="assistant"?(i(),n("div",Re,[e("div",Ue,[e("p",Me,g(d.msg.content),1)])])):d.msg.role==="autonomous"?(i(),n("div",He,[e("div",We,[e("div",Be,[I(o(we),{class:"w-3.5 h-3.5 text-amber-400"}),u[1]||(u[1]=e("span",{class:"text-base text-amber-400/80 font-medium"},"Autonomous",-1))]),e("p",Ge,g(d.msg.content),1)])])):S("",!0)}}),Ke=Object.assign(Ye,{__name:"AIChatMessage"}),s=f([]),$=f(!1),N=f("default");let se=!1;function Je(){const{getAuthHeaders:d}=de();async function p(h,b={}){if(!(!h.trim()||$.value)){s.value=[...s.value,{timestamp:new Date().toISOString(),role:"user",content:h.trim()}],$.value=!0;try{const _=await $fetch("/api/ai/chat",{method:"POST",headers:d(),body:{message:h.trim(),sessionId:N.value,temperature:b.temperature,presetId:b.presetId}});N.value=_.sessionId;for(const m of _.toolCalls)s.value=[...s.value,{timestamp:new Date().toISOString(),role:"tool",content:JSON.stringify(m.result),toolName:m.name,toolArgs:m.args}],u(m.name,m.result);s.value=[...s.value,{timestamp:new Date().toISOString(),role:"assistant",content:_.response}]}catch(_){s.value=[...s.value,{timestamp:new Date().toISOString(),role:"assistant",content:`Error: ${_.data?.message||_.message||"Failed to reach AI assistant"}`}]}finally{$.value=!1}}}async function v(){try{const h=await $fetch("/api/ai/chat-history",{params:{sessionId:N.value,limit:50}});s.value=h.messages,h.sessionId&&(N.value=h.sessionId)}catch{}}async function O(h,b={}){if(!h.trim()||$.value)return;const _=h.trim();s.value=[...s.value,{timestamp:new Date().toISOString(),role:"user",content:_}],$.value=!0;const m=s.value.length;s.value=[...s.value,{timestamp:new Date().toISOString(),role:"assistant",content:""}];try{const A=d(),w=await fetch("/api/ai/chat-stream",{method:"POST",headers:{"Content-Type":"application/json",...A},body:JSON.stringify({message:_,sessionId:N.value,temperature:b.temperature,presetId:b.presetId})});if(!w.ok||!w.body)throw new Error(`HTTP ${w.status}`);const F=w.body.getReader(),X=new TextDecoder;let U="";for(;;){const{done:P,value:j}=await F.read();if(P)break;U+=X.decode(j,{stream:!0});const K=U.split(`

`);U=K.pop()||"";for(const E of K){if(!E.startsWith("data: "))continue;let y=null;try{y=JSON.parse(E.slice(6))}catch{continue}if(y.type==="token"){const C=s.value[m];if(C){const x=[...s.value];x[m]={...C,content:(C.content||"")+y.token},s.value=x}}else if(y.type==="tool")s.value=[...s.value,{timestamp:new Date().toISOString(),role:"tool",content:JSON.stringify(y.result),toolName:y.name,toolArgs:y.args}],u(y.name,y.result);else if(y.type==="done")y.sessionId&&(N.value=y.sessionId);else if(y.type==="error"){const C=s.value[m];if(C){const x=[...s.value];x[m]={...C,content:`Error: ${y.message||"stream error"}`},s.value=x}}}}}catch(A){const w=s.value[m];if(w){const F=[...s.value];F[m]={...w,content:`Error: ${A?.message||"stream failed"}`},s.value=F}}finally{$.value=!1}}async function c(){try{await $fetch("/api/ai/chat-history",{method:"DELETE",headers:d(),body:{sessionId:N.value}}),s.value=[]}catch{}}function u(h,b){typeof window>"u"||h==="propose_trigger_scheme"&&b?.success&&window.dispatchEvent(new CustomEvent("ai-proposal-created",{detail:{proposalId:b.proposalId}}))}function D(){se||typeof window>"u"||(se=!0,window.addEventListener("ai-autonomous",(h=>{const b=h.detail;b?.response&&(s.value=[...s.value,{timestamp:b.timestamp||new Date().toISOString(),role:"autonomous",content:b.response}])})))}return D(),{messages:s,loading:$,sessionId:N,sendMessage:p,sendMessageStreaming:O,loadHistory:v,clearHistory:c}}const ie=[{key:"environment",label:"Environment",icon:"🌡️",color:"emerald"},{key:"cultivation",label:"Cultivation",icon:"🌱",color:"lime"},{key:"devices",label:"Devices",icon:"⚡",color:"amber"},{key:"triggers",label:"Triggers",icon:"🔧",color:"violet"},{key:"reports",label:"Reports",icon:"📊",color:"sky"},{key:"safety",label:"Safety",icon:"🚨",color:"rose"}],ze=[{id:"env-diagnose",category:"environment",label:"Diagnose my VPD",description:"Full diagnosis of current VPD, temp and humidity vs targets.",prompt:`Diagnose my current environment.
...
Output 5 concise steps.`}],ce="s4r:ai-custom-presets",k=f([]);let ne=!1;function Xe(){if(!(typeof localStorage>"u"))try{const d=localStorage.getItem(ce);if(!d)return;const p=JSON.parse(d);Array.isArray(p)&&(k.value=p.slice(0,100))}catch{}}function q(){if(!(typeof localStorage>"u"))try{localStorage.setItem(ce,JSON.stringify(k.value))}catch{}}function Ze(){ne||(Xe(),ne=!0);function d(c){const u={...c,id:`u_${Date.now()}_${Math.random().toString(36).slice(2,6)}`};return k.value=[...k.value,u],q(),u}function p(c){k.value=k.value.filter(u=>u.id!==c),q()}function v(c,u){k.value=k.value.map(D=>D.id===c?{...D,...u,id:D.id}:D),q()}function O(c){return k.value.filter(u=>u.category===c)}return{customPresets:k,add:d,remove:p,update:v,byCategory:O}}const qe={class:"flex flex-col h-full relative"},Qe={class:"flex items-center justify-between px-4 py-2.5 border-b border-gray-700/50 shrink-0"},et={class:"flex items-center gap-2"},tt={class:"w-6 h-6 rounded-lg bg-gradient-to-br from-violet-500/30 to-purple-600/20 flex items-center justify-center"},at={class:"flex items-center gap-1"},ot={class:"relative"},rt={key:0,class:"absolute right-0 top-full mt-1 w-40 bg-gray-900 border border-gray-700/60 rounded-xl shadow-2xl z-20 py-1 max-h-80 overflow-y-auto scrollbar-thin"},st=["onClick"],it={key:0,class:"flex flex-col h-full px-3"},nt={class:"flex flex-col items-center text-center gap-2 py-4"},lt={class:"w-10 h-10 rounded-2xl bg-gradient-to-br from-violet-500/20 to-purple-600/10 flex items-center justify-center"},dt={class:"flex gap-1 overflow-x-auto scrollbar-thin pb-2 mx-0"},ct=["onClick"],ut={class:"text-base"},pt={class:"flex flex-col gap-1.5 overflow-y-auto scrollbar-thin pb-2 pr-1"},mt=["onClick","title"],gt={class:"text-base text-gray-200 font-medium flex items-center gap-1.5"},ht={key:0,class:"text-base"},yt={class:"text-base text-gray-500 leading-snug mt-0.5"},ft=["onClick"],vt={class:"w-full max-w-sm bg-gray-800 border border-gray-700/50 rounded-2xl p-4 space-y-2"},bt={class:"flex items-center justify-between gap-2"},wt=["value"],_t={class:"flex items-center justify-end gap-2 pt-1"},xt=["disabled"],kt={key:2,class:"flex justify-start px-3 py-1"},Ot={class:"bg-violet-600/10 border border-violet-500/20 rounded-2xl rounded-tl-md px-3.5 py-2 flex flex-col gap-1"},Dt={class:"flex items-center gap-2"},Ct={class:"text-base text-violet-400/80"},St={class:"text-violet-400/50"},It={key:0,class:"text-base text-violet-300/60 font-mono"},At={class:"px-3 py-2.5 border-t border-gray-700/50 shrink-0"},Pt={class:"flex gap-2"},Nt=["disabled"],Et=["disabled"],Tt=le({__name:"AIChatPanel",emits:["close"],setup(d){const{messages:p,loading:v,sendMessage:O,loadHistory:c,clearHistory:u}=Je(),{customPresets:D,add:h,remove:b}=Ze(),{getAuthHeaders:_}=de(),m=[{code:"auto",label:"Auto",emoji:"🌐"},{code:"en",label:"English",emoji:"🇬🇧"},{code:"es",label:"Español",emoji:"🇪🇸"},{code:"pt",label:"Português",emoji:"🇵🇹"},{code:"fr",label:"Français",emoji:"🇫🇷"},{code:"de",label:"Deutsch",emoji:"🇩🇪"},{code:"it",label:"Italiano",emoji:"🇮🇹"},{code:"ca",label:"Català",emoji:"🟡"},{code:"nl",label:"Nederlands",emoji:"🇳🇱"},{code:"pl",label:"Polski",emoji:"🇵🇱"},{code:"ja",label:"日本語",emoji:"🇯🇵"},{code:"zh",label:"中文",emoji:"🇨🇳"},{code:"ru",label:"Русский",emoji:"🇷🇺"},{code:"tr",label:"Türkçe",emoji:"🇹🇷"},{code:"ar",label:"العربية",emoji:"🇸🇦"}],A=f("auto"),w=f(!1),F=R(()=>(m.find(r=>r.code===A.value)||m[0]).emoji);async function X(r){A.value=r,w.value=!1;try{await $fetch("/api/settings/preferences",{method:"POST",headers:_(),body:{aiLanguage:r}})}catch{}}async function U(){try{const r=await $fetch("/api/settings/preferences");r?.aiLanguage&&m.some(a=>a.code===r.aiLanguage)&&(A.value=r.aiLanguage)}catch{}}const P=f(""),j=f(null),K=f(null),E=f("environment"),y=R(()=>[...ze.filter(r=>r.category===E.value),...D.value.filter(r=>r.category===E.value)]),C=f(0),x=f(0);let V=null;const ue=R(()=>{const r=Math.max(0,Math.floor(x.value/1e3));return r<60?`${r}s`:`${Math.floor(r/60)}m${r%60}s`}),pe=R(()=>x.value<2e3?"Reading context…":J.value.length===0?"Thinking…":J.value.length<3?"Gathering data…":"Synthesising answer…"),J=R(()=>{const r=p.value.slice(-8).filter(t=>t.role==="tool"&&t.toolName).map(t=>t.toolName),a=new Set,T=[];for(const t of r)a.has(t)||(a.add(t),T.push(t));return T.slice(-4)});te(v,r=>{r?(C.value=Date.now(),x.value=0,V&&clearInterval(V),V=Ie(()=>{x.value=Date.now()-C.value},500)):(V&&(clearInterval(V),V=null),x.value=0)});const M=f(!1),l=f({label:"",description:"",prompt:"",category:"environment",temperature:void 0});function me(){!l.value.label.trim()||!l.value.prompt.trim()||(h({label:l.value.label.trim(),description:l.value.description.trim()||l.value.prompt.trim().slice(0,80),prompt:l.value.prompt.trim(),category:l.value.category,temperature:l.value.temperature}),l.value={label:"",description:"",prompt:"",category:"environment",temperature:void 0},M.value=!1)}function ge(r){b(r)}const he=R(()=>p.value.filter(r=>r.role!=="system"));function H(){ae(()=>{j.value&&(j.value.scrollTop=j.value.scrollHeight)})}async function Q(r){const a=P.value;a.trim()&&(P.value="",await O(a),H())}async function ye(r){v.value||(await O(r.prompt,{temperature:r.temperature,presetId:r.id}),H())}async function fe(){await u()}function ee(r){const a=r.detail||{},T=String(a.prompt||"").trim();!T||v.value||(O(T,{temperature:a.temperature,presetId:a.presetId}),ae(H))}return _e(async()=>{await Promise.all([c(),U()]),H(),typeof window<"u"&&window.addEventListener("ai-send",ee)}),xe(()=>{typeof window<"u"&&window.removeEventListener("ai-send",ee)}),te(()=>p.value.length,()=>{H()}),(r,a)=>{const T=Ke;return i(),n("div",qe,[e("div",Qe,[e("div",et,[e("div",tt,[I(o(oe),{class:"w-3.5 h-3.5 text-violet-400"})]),a[13]||(a[13]=e("h3",{class:"text-base font-semibold text-white"},"AI Assistant",-1)),e("span",{class:z(["w-2 h-2 rounded-full",o(v)?"bg-yellow-400 animate-pulse":"bg-spider-green-400"])},null,2)]),e("div",at,[e("div",ot,[e("button",{onClick:a[0]||(a[0]=t=>w.value=!o(w)),class:"px-2 py-1 text-base font-medium text-gray-500 hover:text-gray-200 hover:bg-gray-700/50 rounded-lg transition-colors flex items-center gap-1",title:"Response language"},g(o(F)),1),o(w)?(i(),n("div",rt,[(i(),n(B,null,G(m,t=>e("button",{key:t.code,onClick:W=>X(t.code),class:z(["w-full px-3 py-1.5 text-left text-base flex items-center gap-2",o(A)===t.code?"bg-violet-500/20 text-violet-200":"text-gray-300 hover:bg-gray-800/60"])},[e("span",null,g(t.emoji),1),e("span",null,g(t.label),1)],10,st)),64))])):S("",!0)]),e("button",{onClick:fe,class:"p-1.5 text-gray-500 hover:text-gray-300 hover:bg-gray-700/50 rounded-lg transition-colors",title:"Clear history"},[I(o(Ae),{class:"w-4 h-4"})]),e("button",{onClick:a[1]||(a[1]=t=>r.$emit("close")),class:"p-1.5 text-gray-500 hover:text-gray-300 hover:bg-gray-700/50 rounded-lg transition-colors"},[I(o(re),{class:"w-4 h-4"})])])]),e("div",{ref_key:"messagesContainer",ref:j,class:"flex-1 overflow-y-auto py-3 space-y-1 min-h-0"},[o(p).length===0&&!o(v)?(i(),n("div",it,[e("div",nt,[e("div",lt,[I(o(oe),{class:"w-5 h-5 text-violet-400/60"})]),a[14]||(a[14]=e("p",{class:"text-base text-gray-400"},"How can I help with your grow?",-1))]),e("div",dt,[(i(!0),n(B,null,G(o(ie),t=>(i(),n("button",{key:t.key,type:"button",onClick:W=>E.value=t.key,class:z(["shrink-0 px-2.5 py-1.5 rounded-lg text-base transition-colors flex items-center gap-1.5 whitespace-nowrap",o(E)===t.key?"bg-violet-500/20 text-violet-200 border border-violet-500/40":"bg-gray-800/40 text-gray-400 border border-gray-700/40 hover:text-gray-200 hover:border-gray-600/40"])},[e("span",null,g(t.icon),1),e("span",ut,g(t.label),1)],10,ct))),128))]),e("div",pt,[(i(!0),n(B,null,G(o(y),t=>(i(),n("button",{key:t.id,type:"button",onClick:W=>ye(t),title:t.description,class:"group relative px-3 py-2 bg-gray-800/50 hover:bg-gray-700/60 border border-gray-700/50 hover:border-violet-500/40 rounded-xl text-left transition-all"},[e("div",gt,[t.id.startsWith("u_")?(i(),n("span",ht,"⭐")):S("",!0),e("span",null,g(t.label),1)]),e("div",yt,g(t.description),1),t.id.startsWith("u_")?(i(),n("button",{key:0,type:"button",class:"absolute top-1.5 right-1.5 opacity-0 group-hover:opacity-100 p-1 text-gray-500 hover:text-rose-400 rounded",title:"Delete custom preset",onClick:Z(W=>ge(t.id),["stop"])},[I(o(re),{class:"w-3.5 h-3.5"})],8,ft)):S("",!0)],8,mt))),128)),e("button",{type:"button",onClick:a[2]||(a[2]=t=>M.value=!0),class:"px-3 py-1.5 border border-dashed border-gray-700/60 hover:border-violet-500/40 rounded-xl text-base text-gray-500 hover:text-violet-300 transition-all"}," + save custom prompt ")])])):S("",!0),o(M)?(i(),n("div",{key:1,class:"absolute inset-0 bg-gray-900/85 backdrop-blur-sm flex items-center justify-center p-4 z-20",onClick:a[9]||(a[9]=Z(t=>M.value=!1,["self"]))},[e("div",vt,[a[15]||(a[15]=e("div",{class:"text-base font-medium text-white mb-1"},"Save your own preset",-1)),L(e("input",{"onUpdate:modelValue":a[3]||(a[3]=t=>o(l).label=t),placeholder:"Label",class:"w-full bg-gray-900/60 border border-gray-700/50 rounded-lg px-3 py-1.5 text-base text-gray-200 placeholder-gray-500 focus:border-violet-500/50 focus:outline-none"},null,512),[[Y,o(l).label]]),L(e("input",{"onUpdate:modelValue":a[4]||(a[4]=t=>o(l).description=t),placeholder:"Description",class:"w-full bg-gray-900/60 border border-gray-700/50 rounded-lg px-3 py-1.5 text-base text-gray-200 placeholder-gray-500 focus:border-violet-500/50 focus:outline-none"},null,512),[[Y,o(l).description]]),L(e("textarea",{"onUpdate:modelValue":a[5]||(a[5]=t=>o(l).prompt=t),placeholder:"Prompt sent to the AI",rows:"4",class:"w-full bg-gray-900/60 border border-gray-700/50 rounded-lg px-3 py-1.5 text-base text-gray-200 placeholder-gray-500 focus:border-violet-500/50 focus:outline-none resize-none"},null,512),[[Y,o(l).prompt]]),e("div",bt,[L(e("select",{"onUpdate:modelValue":a[6]||(a[6]=t=>o(l).category=t),class:"flex-1 bg-gray-900/60 border border-gray-700/50 rounded-lg px-2 py-1.5 text-base text-gray-200 focus:outline-none"},[(i(!0),n(B,null,G(o(ie),t=>(i(),n("option",{key:t.key,value:t.key},g(t.icon)+" "+g(t.label),9,wt))),128))],512),[[ke,o(l).category]]),L(e("input",{"onUpdate:modelValue":a[7]||(a[7]=t=>o(l).temperature=t),type:"number",step:"0.05",min:"0",max:"1",placeholder:"temp",class:"w-16 bg-gray-900/60 border border-gray-700/50 rounded-lg px-2 py-1.5 text-base text-gray-200 focus:outline-none"},null,512),[[Y,o(l).temperature,void 0,{number:!0}]])]),e("div",_t,[e("button",{type:"button",onClick:a[8]||(a[8]=t=>M.value=!1),class:"px-3 py-1.5 text-base text-gray-400 hover:text-gray-200"},"Cancel"),e("button",{type:"button",onClick:me,disabled:!o(l).label.trim()||!o(l).prompt.trim(),class:"px-3 py-1.5 bg-violet-600/80 hover:bg-violet-500 disabled:opacity-40 text-white rounded-lg text-base"},"Save",8,xt)])])])):S("",!0),(i(!0),n(B,null,G(o(he),(t,W)=>(i(),Se(T,{key:W,msg:t},null,8,["msg"]))),128)),o(v)?(i(),n("div",kt,[e("div",Ot,[e("div",Dt,[a[16]||(a[16]=e("span",{class:"flex gap-1"},[e("span",{class:"w-1.5 h-1.5 bg-violet-400 rounded-full animate-bounce",style:{"animation-delay":"0ms"}}),e("span",{class:"w-1.5 h-1.5 bg-violet-400 rounded-full animate-bounce",style:{"animation-delay":"150ms"}}),e("span",{class:"w-1.5 h-1.5 bg-violet-400 rounded-full animate-bounce",style:{"animation-delay":"300ms"}})],-1)),e("span",Ct,[Oe(g(o(pe)),1),e("span",St," · "+g(o(ue)),1)])]),o(J).length?(i(),n("div",It,g(o(J).join(" → ")),1)):S("",!0)])])):S("",!0)],512),e("div",At,[e("div",Pt,[L(e("input",{ref_key:"inputEl",ref:K,"onUpdate:modelValue":a[10]||(a[10]=t=>Ce(P)?P.value=t:null),onKeydown:a[11]||(a[11]=De(Z(t=>Q(),["exact"]),["enter"])),disabled:o(v),placeholder:"Ask about your grow...",class:"flex-1 bg-gray-800/60 border border-gray-600/50 rounded-xl px-3.5 py-2 text-base text-gray-200 placeholder-gray-500 focus:border-violet-500/50 focus:outline-none disabled:opacity-50"},null,40,Nt),[[Y,o(P)]]),e("button",{onClick:a[12]||(a[12]=t=>Q()),disabled:!o(P).trim()||o(v),class:"px-3 py-2 bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-400 hover:to-purple-500 disabled:from-gray-600 disabled:to-gray-600 text-white rounded-xl transition-all flex items-center"},[I(o(Pe),{class:"w-4 h-4"})],8,Et)])])])}}}),Ht=Object.assign(Tt,{__name:"AIChatPanel"});export{Ht as _};
